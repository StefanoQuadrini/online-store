...
public class ShopOnlineApplication implements CommandLineRunner{
    ...
    public void run(String... strings) throws Exception {
        log.info("Hello Quad Shop");

        videoGameDao.save(new VideoGame(1L,"Call of Duty",50.9,"Amazing War game", Product.Categories.VIDEO_GAMES,"Playstation 3", "ff"));
        videoGameDao.save(new VideoGame(5L,"Battlefield",100,"Fantascientific War game", Product.Categories.VIDEO_GAMES,"Playstation 4", "ff"));
        cellPhoneDao.save(new CellPhone(2L,"Huawei",250.33,"Goog Quality respect price", Product.Categories.CELL_PHONES,"Android","Camera 5x","i7","F55Px",2));
